    ...
    <Dialog open={open} onClose={handleClose}>
      ...
      <DialogContent>
        ...
        <FormControl fullWidth margin="dense">
          ...
          <Select  className="!rounded-3xl" name="size" value={newProduct.size} label="Size" onChange={handleChange}>
        ...
        <FormControl fullWidth margin="dense">
          ...
          <Select  className="!rounded-3xl" name="color" value={newProduct.color} label="Color" onChange={handleChange}>
